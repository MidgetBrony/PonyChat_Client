    ...
    public partial class InputPanel : UserControl
    {
        ...
        internal bool ShowSendButton
        {
            ...
            set { 
                ...
                //send button does not hide while in wide mode
                if (this.ShowWideTextPanel == false)
                    buttonSend.Visible = value;
        ...
        private void buttonSend_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                if (FormMain.Instance.IceChatOptions.ShowMultilineEditbox == false)
